...
public class Assignment_casestudy {
	WebDriver driver;
  @Test(dataProvider = "dp")
	  public void f(String fname,String lname,String mail, String pword,String cpword) throws Exception {
	  driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(10));
	  Assignment_POM_Casestudy obj = new Assignment_POM_Casestudy(driver);
	  long timestamp = new Date().getTime();
	  System.out.println("The time is: "+timestamp);
	  
	  ExtentReports extent=new ExtentReports();
		ExtentSparkReporter spark=new ExtentSparkReporter(timestamp+"luma.html");
	  ...
	  if(title.equals("Create New Customer Account"))
		...
		else
		{
			...
			File dfile = new File("C:\\Users\\bhushan.joshi\\eclipse-workspace\\JAN2024_Selenium\\luma1.png");
		...
		else
		{
			...
			File dfile1 = new File("C:\\Users\\bhushan.joshi\\eclipse-workspace\\JAN2024_Selenium\\username.png");
		...
		else
		{
			...
			File dfile2 = new File("C:\\Users\\bhushan.joshi\\eclipse-workspace\\JAN2024_Selenium\\password.png");
...
//	  //js.executeAsyncScript("window.scrollBy(0,document.body.scrollHeight)");
	  ...
	  if(obj.verifylogin())
		...
		else
		{
			...
			File dfile3 = new File("C:\\Users\\bhushan.joshi\\eclipse-workspace\\JAN2024_Selenium\\login.png");
...
//			}
  ...
  public Object[][] dp() throws Exception {
	  File f1 = new File("C:\\Users\\bhushan.joshi\\eclipse-workspace\\JAN2024_Selenium\\Luma_userdetails.xlsx");
